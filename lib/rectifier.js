...
Rectifier.prototype = {
  ...
  /**
   * Wrap in CommonJS module. Options can specify output type as one of 'function', 'component'.
   *
  ...
  commonJS: function(body) {
    ...
    var outputType = this.options.outputType || ((this.options.filename && this.options.filename.match(/.(jade|pug)$/)) ? 'function' : 'component');
    ...
    if (outputType == 'function') {
      ...
      throw new Error("Unknow output type "+outputType);
    }
  },
